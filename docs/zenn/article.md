...
試しに、お住まいの自治体の **「児童手当」のページ** を開いてみてください。計算式、場合分け、法律の但し書き——**正確な情報が並んでいるのに、「自分が対象なのか」にたどり着く前に読む気を失いませんか。**
